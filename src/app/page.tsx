...
{currentView === 'metodologia' && (
  <section className={`py-4 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
    <div className="max-w-4xl mx-auto">
      ...
      {/* ========== NUEVO CONTENIDO: Pasos reales del reto Comfachocó ========== */}
      <section className="metodologia" id="metodologia">
        <header className="metodologia__header">
          <h2 className="metodologia__titulo">Metodología que seguimos para resolver el reto Comfachocó</h2>
          <p className="metodologia__subtitulo">
            Caso real → Análisis → Estudio de modelos → Flujo empleado → Normatividad → Dataset sintético →
            Entrenamiento → Web → Resultados y Prototipo.
          </p>
        </header>

        <article className="paso paso--1">
          <div className="paso__numero">1</div>
          <h3 className="paso__titulo">Partimos del reto Comfachocó</h3>
          <p className="paso__texto">
            La empresa nos planteó: “Reduzcan la carga administrativa de RRHH y agilicen la gestión
            de vacaciones, permisos y licencias”. Entrevistamos a 3 supervisores y 5 empleados de
            áreas operativas y administrativas. Identificamos que el 72 % de las solicitudes se
            iniciaban por WhatsApp o papel y tardaban en promedio <strong>2 h 15 min</strong>.
          </p>
        </article>

        <article className="paso paso--2">
          <div className="paso__numero">2</div>
          <h3 className="paso__titulo">Análisis inicial del problema</h3>
          <p className="paso__texto">
            Mapeamos el flujo actual, identificamos cuellos de botella y validamos normas
            legales colombianas. Concluimos que el error humano y la falta de estandarización
            eran los mayores costos.
          </p>
          <ul className="paso__lista">
            <li>Proceso mapeado: 6 sub-etapas manuales</li>
            <li>Error promedio antes: 18 %</li>
            <li>Tiempo promedio antes: 2 h 15 min</li>
          </ul>
        </article>

        <article className="paso paso--3">
          <div className="paso__numero">3</div>
          <h3 className="paso__titulo">Estudiamos los modelos de Machine Learning</h3>
          <p className="paso__texto">
            Revisamos algoritmos que se adaptaran a <strong>texto corto</strong> (motivo) y
            <strong>variables numéricas</strong> (días, antigüedad, área). Seleccionamos 7 modelos,
            cada uno con una función específica dentro del flujo.
          </p>
          <div className="modelos-grid">
            <div className="modelo-card">Naive Bayes<br /><small>Clasificar tipo</small></div>
            <div className="modelo-card">SVM One-Class<br /><small>Detectar anomalías</small></div>
            <div className="modelo-card">Regresión Lineal<br /><small>Impacto (días)</small></div>
            <div className="modelo-card">Regresión Logística<br /><small>Prob. aprobación</small></div>
            <div className="modelo-card">Árbol de Decisión<br /><small>Decisión final</small></div>
            <div className="modelo-card">K-means<br /><small>Segmentar empleado</small></div>
            <div className="modelo-card">KNN<br /><small>Recomendar días</small></div>
          </div>
        </article>

        <article className="paso paso--4">
          <div className="paso__numero">4</div>
          <h3 className="paso__titulo">Analizamos el flujo real del empleado</h3>
          <p className="paso__texto">
            Recorrimos paso a paso la experiencia de un empleado promedio:
            redacción del motivo, cálculo de días, adjuntar soportes,
            espera de aprobación y notificación. Detectamos:
          </p>
          <ul className="paso__lista">
            <li>3 puntos de fricción al escribir el motivo</li>
            <li>2 confusiones al calcular días hábiles vs calendario</li>
            <li>1 olvido frecuente: no adjuntar soporte obligatorio</li>
          </ul>
        </article>

        <article className="paso paso--5">
          <div className="paso__numero">5</div>
          <h3 className="paso__titulo">Buscamos la normatividad colombiana y establecimos políticas</h3>
          <p className="paso__texto">
            Revisamos el Código Sustantivo de Trabajo y decretos vigentes para
            traducir las reglas en restricciones dentro de los modelos:
          </p>
          <ul className="paso__lista">
            <li>Máximo 8 días hábiles de paternidad (Art. 236 CST)</li>
            <li>Mínimo 6 días continuos en vacaciones si hay acumulación</li>
            <li>Prescripción 3 años para vacaciones no disfrutadas</li>
            <li>Soportes obligatorios: partida de defunción, cita médica, etc.</li>
          </ul>
          <table className="normas">
            <thead><tr><th>Tipo de permiso</th><th>Máx. días</th><th>Soporte obligatorio</th></tr></thead>
            <tbody>
              <tr><td>Paternidad</td><td>8 hábiles</td><td>Partida de nacimiento</td></tr>
              <tr><td>Luto</td><td>5 hábiles</td><td>Partida de defunción</td></tr>
              <tr><td>Vacaciones</td><td>15 hábiles</td><td>Ninguno (solo solicitud)</td></tr>
            </tbody>
          </table>
        </article>

        <article className="paso paso--6">
          <div className="paso__numero">6</div>
          <h3 className="paso__titulo">Construimos dataset sintético para entrenar</h3>
          <p className="paso__texto">
            Como no contábamos con miles de registros reales, usamos Faker y reglas de negocio
            para generar <strong>1 847 filas</strong> equilibradas. Cada fila incluye motivo,
            días, área, antigüedad y etiqueta de anomalía.
          </p>
          <ul className="paso__lista">
        ...
        <article className="paso paso--7">
          <div className="paso__numero">7</div>
          <h3 className="paso__titulo">Entrenamos y evaluamos los 7 modelos</h3>
          <p className="paso__texto">
            Entrenamos con validación cruzada y ajustamos hiper-parámetros.
            Todos los modelos superan <strong>85 % de precisión</strong> en sus tareas específicas.
          </p>
          <table className="metricas">
            <thead><tr><th>Modelo</th><th>Task</th><th>Accuracy / F1</th></tr></thead>
            <tbody>
              <tr><td>Naive Bayes</td><td>Tipo de permiso</td><td>92 %</td></tr>
              <tr><td>SVM One-Class</td><td>Anomalía</td><td>88 %</td></tr>
              <tr><td>Reg. Lineal</td><td>Impacto (días)</td><td>R² = 0.83</td></tr>
              <tr><td>Reg. Logística</td><td>Prob. aprobación</td><td>AUC = 0.91</td></tr>
              <tr><td>Árbol</td><td>Decisión</td><td>94 %</td></tr>
            </tbody>
          </table>
        </article>

        <article className="paso paso--8">
          <div className="paso__numero">8</div>
          <h3 className="paso__titulo">Implementamos la aplicación web</h3>
          <p className="paso__texto">
            Construimos un prototipo funcional con FastAPI (backend) y HTML+CSS+JS (frontend).
            Subimos los 7 modelos y un endpoint único que devuelve **tipo, riesgo, impacto, decisión,
            segmento y días recomendados** en una sola llamada.
          </p>
        </article>

        <article className="paso paso--9">
          <div className="paso__numero">9</div>
          <h3 className="paso__titulo">Medimos resultados y entregamos prototipo</h3>
          <p className="paso__texto">
            En prueba piloto con 23 empleados redujimos el tiempo de gestión a <strong>3 min 20 s</strong>
            y los errores a <strong>2 %</strong>. El prototipo está listo para escalar o integrarse
            al sistema de RRHH de Comfachocó.
          </p>
          <table className="resultados">
            <thead><tr><th>Indicador</th><th>Antes</th><th>Después</th></tr></thead>
            <tbody>
              <tr><td>Tiempo promedio</td><td>2 h 15 min</td><td>3 min 20 s</td></tr>
              <tr><td>% errores</td><td>18 %</td><td>2 %</td></tr>
              <tr><td>Satisfacción usuario</td><td>6.2/10</td><td>9.1/10</td></tr>
            </tbody>
          </table>
        </article>

        <footer className="metodologia__footer">
          <p>
            Puedes reproducir o mejorar esta solución: los notebooks y datasets están en
            <a href="#colab" className="metodologia__link">Colab</a>.
          </p>
        </footer>
      </section>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                <Card className="border-emerald-100 hover:shadow-lg transition-all duration-300">
                  <CardContent className="p-4 text-center">
                    <div className="w-16 h-16 bg-emerald-100 rounded-full mx-auto mb-3 flex items-center justify-center">
                      <span className="text-emerald-700 font-bold text-xl">CG</span>
                    </div>
                    <h3 className="font-semibold text-gray-800">Claudia Gómez Franco</h3>
                    <p className="text-sm text-emerald-600">Centro de Servicios de Salud</p>
                    <p className="text-xs text-gray-600 mt-2">Especialista en...</p>
                  </CardContent>
                </Card>
                ...
                <Card className="border-emerald-100 hover:shadow-lg transition-all duration-300">
                  <CardContent className="p-4 text-center">
                    ...
                    <h3 className="font-semibold text-gray-800">Juan David Suarez Morales</h3>
                    <p className="text-sm text-emerald-600">Centro de tecnología de la manufactura avanzada</p>
                    <p className="text-xs text-gray-600 mt-2">Experto en...</p>
                  </CardContent>
                </Card>
                ...
                <Card className="border-emerald-100 hover:shadow-lg transition-all duration-300">
                  <CardContent className="p-4 text-center">
                    <div className="w-16 h-16 bg-emerald-100 rounded-full mx-auto mb-3 flex items-center justify-center">
                      <span className="text-emerald-700 font-bold text-xl">RM</span>
                    </div>
                    <h3 className="font-semibold text-gray-800">Ruby Martínez Lopera</h3>
                    <p className="text-sm text-emerald-600">Centro de comercio</p>
                    <p className="text-xs text-gray-600 mt-2">Especialista...</p>
                  </CardContent>
                </Card>
                ...
                <Card className="border-emerald-100 hover:shadow-lg transition-all duration-300">
                  <CardContent className="p-4 text-center">
                    <div className="w-16 h-16 bg-emerald-100 rounded-full mx-auto mb-3 flex items-center justify-center">
                      <span className="text-emerald-700 font-bold text-xl">SY</span>
                    </div>
                    <h3 className="font-semibold text-gray-800">Sor Yanet Salazar Alzate</h3>
                    <p className="text-sm text-emerald-600">Centro de comercio</p>
                    <p className="text-xs text-gray-600 mt-2">Experta...</p>
                  </CardContent>
                </Card>
              </div>
            </div>
  ...
  .normas, .metricas, .resultados {
    width: 100%;
    border-collapse: collapse;
    margin: 1rem 0;
    font-size: 0.9rem;
  }
  .normas th, .metricas th, .resultados th,
  .normas td, .metricas td, .resultados td {
